...
// Public static constants
    ...
    public static final String DEFAULT_HUMAN_NAME = "Human";
    public static final String WINDOW_TITLE = "Battleships";
...
// Nested classes
    /**
     * Runs the GUI for one Game.
     */
    private static class GameWindow {
        // Nested classes

        /**
         * Runs the GUI during the attacking phase of the game.
         */
        private static class AttackPhaseHandler implements PlayerDisplayListener {
            // Public fields
        ...
        /**
         * Runs the GUI for the deployment phase of the game.
         */
        ...
        /**
         * Manages the GUI that displays the player's grid, status and ships.
         */
        private static class PlayerDisplay implements PlayerDisplayListener {
            ...
            private void constructGUI() {
                ...
                this.contentPanel = new JPanel();
                {
                    ...
                    {
                        this.laStatus.setBorder(new EmptyBorder(UI.BORDER_WIDTH, UI.BORDER_WIDTH, UI.BORDER_WIDTH, UI.BORDER_WIDTH));
                        this.laStatus.setHorizontalAlignment(SwingConstants.CENTER);
                    }

                    this.contentPanel.setBorder(new EmptyBorder(UI.BORDER_WIDTH, UI.BORDER_WIDTH, UI.BORDER_WIDTH, UI.BORDER_WIDTH));
            ...
            private void redrawCell(int x, int y) {
                int displayState = this.myPlayer.getGrid().getCell(x, y).displayState(this.myGameWindow.getHumanPlayer());
        ...
        /**
         * Handles events on the player display.
         */
        ...
        public GameWindow(UI ui) {
            this.myUI = ui;
            this.myGame = new Game(ui.getPlayerName(), "Computer");
        ...
        private void constructGUI() {
            ...
            JPanel buttonsPanel = new JPanel();
            {
                ...
                buttonsPanel.add(bnRotateShip = gameWindow.myDeployer.bnRotateShip = new JButton("Rotate ship"));
    ...
    /**
     * Runs the starter window.
     */
    private static class StarterWindow {
        // Private fields

        private JCheckBox cxCheat;
        private JFrame form;
        private UI myUI;
        private JTextField tbName;

        // Constructors
        public StarterWindow(UI ui) {
            this.myUI = ui;
            this.constructGUI();
        }
        ...
        // Public methods
        public void onOK() {
            UI.isCheating = this.cxCheat.isSelected();
            this.myUI.setPlayerName(this.playerName());
            this.form.dispose();

            this.myUI.runNewGame();
        }

        public String playerName() {
            String name = this.tbName.getText();
            if (name.length() == 0) {
                name = UI.DEFAULT_HUMAN_NAME;
            }
            return name;
        }
        ...
        // Private methods
        private void constructGUI() {
            final StarterWindow starterWindow = this;
            ...
            JPanel bottomPanel = new JPanel();
            {
                ...
                bottomPanel.add(this.cxCheat = new JCheckBox("Cheat", false), BorderLayout.WEST);
            ...
            JFrame form = this.form = new JFrame(UI.WINDOW_TITLE);
            {
                ...
                mainPanel.setBorder(new EmptyBorder(UI.BORDER_WIDTH, UI.BORDER_WIDTH, UI.BORDER_WIDTH, UI.BORDER_WIDTH));
